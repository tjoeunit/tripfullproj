package com.tjoeunit.biz.certification.Impl;
...
public class CertificationServiceImpl implements CertificationService{
	...
	public void certifiedPhoneNumber(String phoneNumber, String certNum) {
		String api_key = "NCSL8M9EJVBOYFUP";
	    String api_secret = "S9E2CISH0PTTVLRWGH8PEPKKXU01D9KH";
	    ...
	    params.put("type", "SMS");
	    params.put("text", "Tripfull 가입 인증번호는 " + "["+certNum+"]" + " 입니다.");
