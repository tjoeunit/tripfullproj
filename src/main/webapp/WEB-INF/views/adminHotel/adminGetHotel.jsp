...
<main>
	...
	<div class="admin_subtitle">
		<span class="admin_subtitle_name">숙박 상품 상세보기</span>
		<span class="update_delete">
			<a href="<c:url value='/adminHotel/adminHotelUpdatePage.do?hotel_no=${ hotel.hotel_no }'/>">상품수정</a>
		</span>
		<span class="update_delete">
	...
	<div>
		<div type="hidden" value="adminHotelDetail.do?hotel_no=${ hotel.hotel_no }" ></div>
