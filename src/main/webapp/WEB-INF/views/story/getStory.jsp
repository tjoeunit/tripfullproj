...
<main>
	...
	<div class="get_story_inform">
		...
		<fmt:formatDate value="${ story.story_date }" dateStyle="full"
			timeStyle="full" />
	...
	<br> <br> <br> ${story.story_content} <br> <br>
	<br>
	...
	<div style="width: 700px; text-align: center;">
		...
		<!-- 즉 로그인을 한 상태이어야만 댓글을 작성 할 수 있다.-->
		<c:if test="${members_id != null}">

			<textarea rows="2" cols="120" id="reply_text"
...
<!-- 	<script type="text/javascript">	
		$(function(){
		    $("#btnReply").click(function(){
		        ...
		        var story_no=$("#story_no").val(); //게시글 번호
		        var members_id=$("#members_id").val(); //아이디
		        
		        var param={"reply_text": reply_text, "story_no": story_no, "members_id": members_id};
		        
		        $.ajax({
		            type: "post", //데이터를 보낼 방식
		            url: "<c:url value='/story/storyReplyinsert.do'/>", //데이터를 보낼 url
		            data: param, //보낼 데이터
		...
		<script type="text/javascript">	
			$(function(){
				 ...
				 $("#btnReply").click(function(){
					...
					var story_no=$("#story_no").val();
				
					function listReply(){
					    $.ajax({
					        type: "get", //get방식으로 자료를 전달한다
					        url: "<c:url value='/story/storyReplylist.do?story_no="+story_no+"'/>", //컨트롤러에 있는 storyReplylist.do로 맵핑하고 게시판 번호도 같이 보낸다.
	...
	<div class="get_story_bottom">
		<a id="story_modify_a"
			href="updateStoryPage.do?story_no=${story.story_no}">수정하기</a>&nbsp;&nbsp;&nbsp;&nbsp;
		<a id="story_delete_a"
			href="deleteStory.do?story_no=${story.story_no}">삭제하기</a>&nbsp;&nbsp;&nbsp;&nbsp;
