	...
	<nav class="nav">
		<div class="navDiv">
			...
			<div class="navListDiv">
				<ul>
					<li><a href="<c:url value='/index/termService.jsp'/>" class="serviceCheck">이용약관</a></li>
...
<main>
	<h3>제 1 조 (목적)</h3>
	<p>이 약관은 주식회사 마이리얼트립(이하 "당사"이라 합니다)이 운영하는 웹사이트(https://www.myrealtrip.com/) 및 어플리케이션(Application,
	이하 웹사이트와 어플리케이션을 통칭하여 "마이리얼트립 플랫폼")에서 제공하는 서비스(이하 "서비스"라 합니다)를 이용함에 있어 "당사"와 이용자의 권리 및 의무 및 책임사항을
	규정함을 목적으로 합니다.</p>
	
	<h3>제 2 조 (정의)</h3>
	<p>1. "당사"란 서비스를 제공하는 (주)마이리얼트립을 말하며, (주)마이리얼트립이 중개 및 판매하는 재화 또는 용역(이하 "재화 등"이라 합니다)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장인 사이버 몰의 의미로도 사용합니다.
	...
	<br>5. "가이드"라고 함은 파트너 중 마이리얼트립 플랫폼을 통해 직접 여행지에서 여행자에게 투어 서비스를 제공하는 자를 말합니다.
	</p>
