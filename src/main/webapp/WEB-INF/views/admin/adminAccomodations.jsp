...
<link rel="stylesheet" href="../resources/css/admin/adminAccomodations.css">
            ...
            <div class="admin_wrap">
                ...
                <div class="admin_content_wrap">
					...
					<div class="admin_content_goods_submit">                    
	                    <form action="accomodationsEnroll.do">
	                   		 <input type="submit" value="등록">
	                    </form>
	                </div>
	                <div class="admin_content_goods_submit">    
	                   <form action="accomodationsUpdate.do">
	                   		 <input type="submit" value="수정">
	                    </form>
	                </div>
	                <div class="admin_content_goods_submit">    
	                   <form action="accomodationsDelete.do">
