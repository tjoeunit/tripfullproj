	...
	<div	class="product_list">
		<c:forEach items="${ activityList }" var="activity">
			<a href="<c:url value='getActivity.do?activity_no=${ activity.activity_no }'/>">
				<div class="product">
					<img class="product_thumb" src="<c:url value='/activityUpload/${ activity.activity_thumb }'/>">
					<div>
						<div class="product_area">${ activity.activity_area }</div>
						<div class="product_title">${ activity.activity_title }</div>
						<div class="product_price">${ activity.activity_price } 원</div>
					</div>
				</div>
			</a>
		</c:forEach>
