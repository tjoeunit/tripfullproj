...
<main>
	...
	<span>액티비티 등록</span>
	<br>			
	<form name="update_Activity" action="<c:url value='/activity/updateActivity.do'/>" method="post" enctype="multipart/form-data">
		<input type="hidden" name="activity_no" value="${activity.activity_no}">
		<table>
			<tr>
				<td>제목</td>
				<td><input type="text" name="activity_title" id="activity_title" value="${activity.activity_title}"/></td>
			</tr>
			<tr>
<!-- 				<td>카테고리</td>
				<td>
	 ...
	 -->		</tr>
			...
			<tr>
				<td>가격</td>
				<td><input type="text" name="activity_price" id="activity_price" value="${activity.activity_price}"/>원</td>
			</tr>
			<tr>
				<td>내용</td>
				<td>
