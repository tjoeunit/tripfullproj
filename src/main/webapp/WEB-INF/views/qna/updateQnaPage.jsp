...
<script type="text/javascript">
	$(function() {
		$('form[name=enroll_updated_qna]').submit(function() {
...
<!-- ckeditor 4 -->
 	<script type="text/javascript" src = "<c:url value = '/ckeditor/ckeditor.js' />"></script>
			<br><h1>문의사항 수정</h1><hr><br>
			<form action="updateQna.do?qna_no=${qna.qna_no}" name="enroll_updated_qna" method="post" enctype="multipart/form-data">
				<input type="hidden" name="members_no" value="${members_no}">
				<table class="qna_update">
					<tr>
						<td class="update_qna_subject">제목</td>
						<td><input type="text" id="qna_title" name="qna_title" value="${qna.qna_title}"/></td>
					</tr>
					
					<tr>
						<td class="update_qna_writer">작성자</td>
						<td><input type="text" name="qna_writer" value="${qna.qna_writer}" readonly></td>
					</tr>
					<tr>
						<td class="update_qna_content">내용</td>
						<td>
							<textarea id="qna_content" name="qna_content">${qna.qna_content}</textarea>
							<script type="text/javascript">
