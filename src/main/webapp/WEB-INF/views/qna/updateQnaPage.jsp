...
<!-- ckeditor 4 -->
 	...
 	<div class="main_title">문의사항 수정</div>
	<hr>
		...
		<div>
			<table class="insert_table">
				<tr>
					...
					<td class="table_td2"><input type="text" id="qna_title" name="qna_title" class="insert_input" value="${qna.qna_title}"/></td>
				</tr>
				
				<tr>
					<td class="table_td1">작성자</td>
					<td class="table_td2"><input type="text" name="qna_writer" class="input_readonly" value="${qna.qna_writer}" readonly></td>
				</tr>
					
				<tr>
					<td class="table_td1">내용</td>
					<td class="table_td2">
						<textarea id="qna_content" name="qna_content" class="ckeditor">${qna.qna_content}</textarea>
						<script type="text/javascript">
