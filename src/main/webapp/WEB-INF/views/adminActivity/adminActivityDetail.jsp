...
<main>
	...
	<div>
		<div type="hidden" value="adminActivityDetail.do?activity_no=${ activity.activity_no }" ></div>
			<table class="detail_table">
				<tr>
					<td class="table_td1">제목</td>
					<td class="table_td2">${ activity.activity_title }</td>
				</tr>
				
				<tr>
					<td class="table_td1">지역</td>
					<td class="table_td2">${ activity.activity_area }</td>
				</tr>
				
				<tr>
					<td class="table_td1">가격</td>
					<td class="table_td2">${activity.activity_price} 원</td>
				</tr>
				
				<tr>
					<td class="table_td1">썸네일</td>
					<td class="table_td2">${ activity.activity_thumb }</td>
				</tr>
				
<%-- 		<tr>
					<td class="table_td1">영상url</td>
					<td class="table_td2">${ activity.activity_video }</td>
				</tr>
 --%>				
				<tr>
			...
			<div class="ck_content">${ activity.activity_content }</div>
