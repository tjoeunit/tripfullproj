            ...
            <div class="admin_wrap">
                ...
                <div class="admin_navi_wrap">
                 	<h2>상품</h2>
	                  <ul>
	                      <li >
	                          <a class="admin_list_01" href="/admin/flightEnroll">항공</a>
	                      </li>
	                      <li>
	                          <a class="admin_list_02" href="/admin/goodsEnroll">숙박</a>
	                      </li>
	                      <li>
	                          <a class="admin_list_03" href="/admin/activityEnroll">액티비티</a>                            
	                      </li>
	                      <li>
	                          <a class="admin_list_04" href="/admin/lanTripEnroll">랜선여행</a>                            
	                      </li>
	                    </ul>
	                <h2>고객</h2>
	                  <ul>
                ...
                <div class="admin_content_wrap">
                    ...
                    <div class="admin_content_flight"></div>
